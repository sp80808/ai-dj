# 🎧 DJ-IA: AI-powered DJ System with Advanced Spectral Analysis
...
🎬 **[Download video demonstration with sound](./example/poc_ai_dj.mp4)**

![DJ-IA Banner](https://placehold.co/800x200/1a1a1a/FFFFFF?text=DJ-IA)

## ✨ Features

- 🧠 Generative AI for DJ decisions and audio generation
- 🔊 **NEW: Spectral analysis and stem separation for intelligent mixing**
- 🎭 **NEW: Intelligent selection of complementary instruments**
- 🎹 **NEW: Respect for LLM stem preferences (even with low energy)**
- 🧩 **NEW: Support for multiple audio generation models (MusicGen and Stable Audio Open)**
- 🎛️ Real-time audio layer management system (max 3 simultaneous layers)
- 🎚️ Audio effects: filters, panning, reverb, and delay
- 🎵 Support for 10 different musical styles
- 🔄 Synchronized transitions and natural musical progression
- 🗣️ Voice interventions generated by TTS
...
## 🎮 Live Control and Command Interface
...
```
💬 Command (r=reject, g=generate, q=quit, h=help) >
```
...
| ------------------ | -------------------------------------------------------- | ------------- |
| 🔄 `r`, `next`     | Reject current sample and immediately generate a new one | `r`           |
| 🎯 `g`, `generate` | Request a specific sample from the LLM                   | `g deep bass` |
| ❌ `q`, `quit`     | Gracefully exit the application                          | `q`           |
| ℹ️ `h`, `help`     | Display help and available commands                      | `h`           |
...
```
💬 Command > g atmospheric pad with reverb
🎯 Generating specific sample: 'atmospheric pad with reverb'
✓ Generating 'techno_pad' in progress...
```
...
### 🎛️ Spectral Analysis and Stem Separation
